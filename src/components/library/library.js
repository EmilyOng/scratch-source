...
var _libraryItem = require('../library-item/library-item.js');
...
var LibraryComponent = function (_React$Component) {
    ...
    function LibraryComponent(props) {
        ...
        (0, _lodash2.default)(_this, ['handleBlur', 'handleFilterChange', 'handleFilterClear', 'handleFocus', 'handleMouseEnter', 'handleMouseLeave', 'handleSelect']);
        _this.state = {
            selectedItem: null,
            filterQuery: ''
        };
    ...
    _createClass(LibraryComponent, [{
        key: 'handleBlur',
        value: function handleBlur(id) {
            this.handleMouseLeave(id);
        }
    }, {
        key: 'handleFocus',
        value: function handleFocus(id) {
        ...
        value: function getFilteredData() {
            ...
            return this.props.data.filter(function (dataItem) {
                return dataItem.name.toLowerCase().indexOf(_this2.state.filterQuery.toLowerCase()) !== -1;
            });
        }
    }, {
        key: 'render',
