...
var _costumeTab = require('../../containers/costume-tab.js');
...
var _targetPane = require('../../containers/target-pane.js');

var _targetPane2 = _interopRequireDefault(_targetPane);

var _soundTab = require('../../containers/sound-tab.js');
...
var _menuBar = require('../menu-bar/menu-bar.js');
...
var addExtensionMessage = _react2.default.createElement(_reactIntl.FormattedMessage, {
...
var GUIComponent = function GUIComponent(props) {
    var basePath = props.basePath,
        ...
        componentProps = _objectWithoutProperties(props, ['basePath', 'children', 'enableExtensions', 'vm', 'onExtensionButtonClick', 'onTabSelect', 'tabIndex']);
    ...
    var tabClassNames = {
        ...
        tab: (0, _classnames2.default)(_reactTabs3.default.reactTabsTab, _gui2.default.tab),
        tabList: (0, _classnames2.default)(_reactTabs3.default.reactTabsTabList, _gui2.default.tabList),
        tabPanel: (0, _classnames2.default)(_reactTabs3.default.reactTabsTabPanel, _gui2.default.tabPanel),
        tabPanelSelected: (0, _classnames2.default)(_reactTabs3.default.reactTabsTabPanelSelected, _gui2.default.isSelected),
        tabSelected: (0, _classnames2.default)(_reactTabs3.default.reactTabsTabSelected, _gui2.default.isSelected)
    };
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _reactTabs.Tabs,
                        {
                            ...
                            forceRenderTabPanel: true // eslint-disable-line react/js-boolean-value
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(_iconButton2.default, {
                                    className: (0, _classnames2.default)(_gui2.default.extensionButton, _defineProperty({}, _gui2.default.hidden, !enableExtensions)),
                        ...
                        _react2.default.createElement(
                            _reactTabs.TabPanel,
                            { className: tabClassNames.tabPanel },
                            tabIndex === 1 ? _react2.default.createElement(_costumeTab2.default, { vm: vm }) : null
                        ),
                        _react2.default.createElement(
                            _reactTabs.TabPanel,
                            { className: tabClassNames.tabPanel },
                            tabIndex === 2 ? _react2.default.createElement(_soundTab2.default, { vm: vm }) : null
                        )
                    )
                ),
                _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            function (isFullSize) {
                                return _react2.default.createElement(_stage2.default, {
                                    height: isFullSize ? _layoutConstants2.default.fullStageHeight : _layoutConstants2.default.smallerStageHeight,
                                    shrink: 0,
                                    vm: vm,
                                    width: isFullSize ? _layoutConstants2.default.fullStageWidth : _layoutConstants2.default.smallerStageWidth
                                });
                            }
                        )
                    ),
