...
var _spriteInfo = require('../../containers/sprite-info.js');

var _spriteInfo2 = _interopRequireDefault(_spriteInfo);

var _spriteSelectorItem = require('../../containers/sprite-selector-item.js');
...
var addSpriteMessage = _react2.default.createElement(_reactIntl.FormattedMessage, {
...
var SpriteSelectorComponent = function SpriteSelectorComponent(props) {
    var onChangeSpriteDirection = props.onChangeSpriteDirection,
        ...
        componentProps = _objectWithoutProperties(props, ['onChangeSpriteDirection', 'onChangeSpriteName', 'onChangeSpriteRotationStyle', 'onChangeSpriteVisibility', 'onChangeSpriteX', 'onChangeSpriteY', 'onDeleteSprite', 'onDuplicateSprite', 'onNewSpriteClick', 'onSelectSprite', 'selectedId', 'sprites']);
