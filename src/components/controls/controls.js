...
var _greenFlag = require('../green-flag/green-flag.js');

var _greenFlag2 = _interopRequireDefault(_greenFlag);

var _stopAll = require('../stop-all/stop-all.js');

var _stopAll2 = _interopRequireDefault(_stopAll);

var _turboMode = require('../turbo-mode/turbo-mode.js');
...
var Controls = function Controls(props) {
    var active = props.active,
        ...
        turbo = props.turbo,
        componentProps = _objectWithoutProperties(props, ['active', 'className', 'onGreenFlagClick', 'onStopAllClick', 'turbo']);

    return _react2.default.createElement(
        'div',
        _extends({
            className: (0, _classnames2.default)(_controls2.default.controlsContainer, className)
        }, componentProps),
