...
var _loupe = require('../loupe/loupe.js');

var _loupe2 = _interopRequireDefault(_loupe);

var _monitorList = require('../../containers/monitor-list.js');

var _monitorList2 = _interopRequireDefault(_monitorList);

var _question = require('../../containers/question.js');
...
var StageComponent = function StageComponent(props) {
    var canvasRef = props.canvasRef,
        ...
        boxProps = _objectWithoutProperties(props, ['canvasRef', 'width', 'height', 'colorInfo', 'onDeactivateColorPicker', 'isColorPicking', 'question', 'onQuestionAnswered']);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            _box2.default,
            {
                className: (0, _classnames2.default)(_stage2.default.stageWrapper, _defineProperty({}, _stage2.default.withColorPicker, isColorPicking))
            },
            _react2.default.createElement(_box2.default, _extends({
            ...
            isColorPicking && colorInfo ? _react2.default.createElement(
                _box2.default,
                { className: _stage2.default.colorPickerWrapper },
                _react2.default.createElement(_loupe2.default, { colorInfo: colorInfo })
            ) : null,
            question === null ? null : _react2.default.createElement(_question2.default, {
                question: question,
                onQuestionAnswered: onQuestionAnswered
            })
        ),
        isColorPicking ? _react2.default.createElement(_box2.default, {
